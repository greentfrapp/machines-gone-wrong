...
<div>
<img class="comic" width="400px" src="{{ "/assets/comics/disparate.png" | relative_url }}" title="I also heard animals that begin with 'C' need more food." alt="Disparate treatment vs disparate impact.">
</div>
...
<div>
<img class="comic" width="450px" src="{{ "/assets/comics/cat_1.png" | relative_url }}" title="Or maybe he's pregnant." alt="Fat pet predictor.">
</div>
...
<div>
<img class="comic" width="200px" src="{{ "/assets/comics/cat_2.png" | relative_url }}" title="That's what statistics means right?" alt="40% of cats are overweight.">
</div>
...
<div>
<img class="comic" width="450px" src="{{ "/assets/comics/manymetrics.png" | relative_url }}" title="Is the temperature in Kelvin, Celsius or Farenheit? Yes." alt="There are a ton of metrics to measure fairness.">
</div>
...
<div>
<img class="comic" width="450px" src="{{ "/assets/comics/bongo.gif" | relative_url }}" title="" alt="Some fairness definitions are mutually exclusive.">
</div>
...
<div>
<img class="comic" width="450px" src="{{ "/assets/comics/impossible.png" | relative_url }}" title="I told you we shouldn't have used Farenheit." alt="So fairness is impossible?">
</div>
...
<div>
<img class="comic" width="200px" src="{{ "/assets/comics/abstraction.png" | relative_url }}" title="Yes, the stick figures actually symbolize how we often neglect important details. Definitely not because I'm lazy or bad at drawing." alt='Abstraction" is when we make a complex thing simple by ignoring all the unnecessary details.'>
</div>
...
<div>
<img class="comic" width="250px" src="{{ "/assets/comics/context_1.png" | relative_url }}" title="*meow meow meow*" alt="Involve as many people as you can!">
</div>
...
<div>
<img class="comic" width="250px" src="{{ "/assets/comics/context_2.png" | relative_url }}" title="*meow meow meow*" alt="Involve as many people as you can!">
</div>
